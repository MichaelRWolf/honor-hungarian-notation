...
Part of a two-repo project; the tooling lives in `pos-decorate`.

## Plan File
`~/.claude/plans/i-have-long-wanted-compiled-robin.md`

## Current Phase
Phase 0 — copy speech source → speech.md
...
- Refrain: "...for Hungarian Notation is an honorable practice"
- Audience: programmers who already know HN — no explanation, honor their intelligence
- Default view: As Written (plain prose); button adds decoration
